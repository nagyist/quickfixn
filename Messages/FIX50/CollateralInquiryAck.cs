...
public class CollateralInquiryAck : Message
{
    ...
    {
        Header.SetField(new MsgType("BG"));
    }

    public CollateralInquiryAck(
            CollInquiryID aCollInquiryID,
            CollInquiryStatus aCollInquiryStatus
        ) : this()
    {
        CollInquiryID = aCollInquiryID;
        CollInquiryStatus = aCollInquiryStatus;
    ...
    public void Set(CollInquiryID val) { CollInquiryID = val; }
    public CollInquiryID Get(CollInquiryID val) { GetField(val); return val; }
    public bool IsSet(CollInquiryID val) { return IsSetCollInquiryID(); }
    public bool IsSetCollInquiryID() { return IsSetField(Tags.CollInquiryID); }

    public CollInquiryStatus CollInquiryStatus
    {
        get
        {
            CollInquiryStatus val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(CollInquiryStatus val) { CollInquiryStatus = val; }
    public CollInquiryStatus Get(CollInquiryStatus val) { GetField(val); return val; }
    public bool IsSet(CollInquiryStatus val) { return IsSetCollInquiryStatus(); }
    public bool IsSetCollInquiryStatus() { return IsSetField(Tags.CollInquiryStatus); }

    public CollInquiryResult CollInquiryResult
    {
        get
        {
            CollInquiryResult val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(CollInquiryResult val) { CollInquiryResult = val; }
    public CollInquiryResult Get(CollInquiryResult val) { GetField(val); return val; }
    public bool IsSet(CollInquiryResult val) { return IsSetCollInquiryResult(); }
    public bool IsSetCollInquiryResult() { return IsSetField(Tags.CollInquiryResult); }

    public NoCollInquiryQualifier NoCollInquiryQualifier
    {
        get
        {
            NoCollInquiryQualifier val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(NoCollInquiryQualifier val) { NoCollInquiryQualifier = val; }
    public NoCollInquiryQualifier Get(NoCollInquiryQualifier val) { GetField(val); return val; }
    public bool IsSet(NoCollInquiryQualifier val) { return IsSetNoCollInquiryQualifier(); }
    public bool IsSetNoCollInquiryQualifier() { return IsSetField(Tags.NoCollInquiryQualifier); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.CollInquiryQualifier, 0];
        ...
        public NoCollInquiryQualifierGroup()
          : base(Tags.NoCollInquiryQualifier, Tags.CollInquiryQualifier, DefaultFieldOrder)
        {
        }
        ...
        public void Set(CollInquiryQualifier val) { CollInquiryQualifier = val; }
        public CollInquiryQualifier Get(CollInquiryQualifier val) { GetField(val); return val; }
        public bool IsSet(CollInquiryQualifier val) { return IsSetCollInquiryQualifier(); }
        public bool IsSetCollInquiryQualifier() { return IsSetField(Tags.CollInquiryQualifier); }
    }
