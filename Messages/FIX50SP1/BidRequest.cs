...
public class BidRequest : Message
{
    ...
    public BidRequest(
            ...
            TotNoRelatedSym aTotNoRelatedSym,
            BidType aBidType,
            BidTradeType aBidTradeType,
    ...
    public void Set(BidTradeType val) { BidTradeType = val; }
    public BidTradeType Get(BidTradeType val) { GetField(val); return val; }
    public bool IsSet(BidTradeType val) { return IsSetBidTradeType(); }
    public bool IsSetBidTradeType() { return IsSetField(Tags.BidTradeType); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.ListID, Tags.Side, Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.NetGrossInd, Tags.SettlType, Tags.SettlDate, Tags.Account, Tags.AcctIDSource, 0];
