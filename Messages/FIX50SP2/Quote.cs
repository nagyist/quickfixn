...
public class Quote : Message
{
    ...
    public void Set(BidSwapPoints val) { BidSwapPoints = val; }
    public BidSwapPoints Get(BidSwapPoints val) { GetField(val); return val; }
    public bool IsSet(BidSwapPoints val) { return IsSetBidSwapPoints(); }
    public bool IsSetBidSwapPoints() { return IsSetField(Tags.BidSwapPoints); }

    public OfferSwapPoints OfferSwapPoints
    {
        get
        {
            OfferSwapPoints val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(OfferSwapPoints val) { OfferSwapPoints = val; }
    public OfferSwapPoints Get(OfferSwapPoints val) { GetField(val); return val; }
    public bool IsSet(OfferSwapPoints val) { return IsSetOfferSwapPoints(); }
    public bool IsSetOfferSwapPoints() { return IsSetField(Tags.OfferSwapPoints); }
