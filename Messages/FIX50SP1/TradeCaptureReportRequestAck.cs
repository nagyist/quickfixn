...
public class TradeCaptureReportRequestAck : Message
{
    ...
    {
        Header.SetField(new MsgType("AQ"));
    }

    public TradeCaptureReportRequestAck(
            TradeRequestID aTradeRequestID,
            TradeRequestType aTradeRequestType,
            TradeRequestResult aTradeRequestResult,
            TradeRequestStatus aTradeRequestStatus
        ) : this()
    {
        TradeRequestID = aTradeRequestID;
        TradeRequestType = aTradeRequestType;
    ...
    public void Set(TradeRequestResult val) { TradeRequestResult = val; }
    public TradeRequestResult Get(TradeRequestResult val) { GetField(val); return val; }
    public bool IsSet(TradeRequestResult val) { return IsSetTradeRequestResult(); }
    ...
    public void Set(TradeRequestStatus val) { TradeRequestStatus = val; }
    public TradeRequestStatus Get(TradeRequestStatus val) { GetField(val); return val; }
    public bool IsSet(TradeRequestStatus val) { return IsSetTradeRequestStatus(); }
