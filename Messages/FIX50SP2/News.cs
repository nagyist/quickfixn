...
public class News : Message
{
    ...
    public void Set(NewsID val) { NewsID = val; }
    public NewsID Get(NewsID val) { GetField(val); return val; }
    public bool IsSet(NewsID val) { return IsSetNewsID(); }
    public bool IsSetNewsID() { return IsSetField(Tags.NewsID); }

    public NoNewsRefIDs NoNewsRefIDs
    {
        get
        {
            NoNewsRefIDs val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(NoNewsRefIDs val) { NoNewsRefIDs = val; }
    public NoNewsRefIDs Get(NoNewsRefIDs val) { GetField(val); return val; }
    public bool IsSet(NoNewsRefIDs val) { return IsSetNoNewsRefIDs(); }
    public bool IsSetNoNewsRefIDs() { return IsSetField(Tags.NoNewsRefIDs); }

    public NewsCategory NewsCategory
    {
        get
        {
            NewsCategory val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(NewsCategory val) { NewsCategory = val; }
    public NewsCategory Get(NewsCategory val) { GetField(val); return val; }
    public bool IsSet(NewsCategory val) { return IsSetNewsCategory(); }
    public bool IsSetNewsCategory() { return IsSetField(Tags.NewsCategory); }

    public LanguageCode LanguageCode
    {
        get
        {
            LanguageCode val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(LanguageCode val) { LanguageCode = val; }
    public LanguageCode Get(LanguageCode val) { GetField(val); return val; }
    public bool IsSet(LanguageCode val) { return IsSetLanguageCode(); }
    public bool IsSetLanguageCode() { return IsSetField(Tags.LanguageCode); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.NewsRefID, Tags.NewsRefType, 0];

        [Obsolete("Use DefaultFieldOrder instead.  This will be removed in 1.16.")]
        public static int[] fieldOrder = {Tags.NewsRefID, Tags.NewsRefType, 0};

        public NoNewsRefIDsGroup()
          : base(Tags.NoNewsRefIDs, Tags.NewsRefID, DefaultFieldOrder)
        {
        }
        ...
        public void Set(NewsRefID val) { NewsRefID = val; }
        public NewsRefID Get(NewsRefID val) { GetField(val); return val; }
        public bool IsSet(NewsRefID val) { return IsSetNewsRefID(); }
        public bool IsSetNewsRefID() { return IsSetField(Tags.NewsRefID); }
        ...
        public void Set(NewsRefType val) { NewsRefType = val; }
        public NewsRefType Get(NewsRefType val) { GetField(val); return val; }
        public bool IsSet(NewsRefType val) { return IsSetNewsRefType(); }
        public bool IsSetNewsRefType() { return IsSetField(Tags.NewsRefType); }
    }
}
