...
public class ExecutionAcknowledgement : Message
{
    ...
    {
        Header.SetField(new MsgType("BN"));
    }

    public ExecutionAcknowledgement(
            OrderID aOrderID,
            ExecAckStatus aExecAckStatus,
            ExecID aExecID,
            Side aSide
        ) : this()
    {
    ...
    public void Set(ExecAckStatus val) { ExecAckStatus = val; }
    public ExecAckStatus Get(ExecAckStatus val) { GetField(val); return val; }
    public bool IsSet(ExecAckStatus val) { return IsSetExecAckStatus(); }
    public bool IsSetExecAckStatus() { return IsSetField(Tags.ExecAckStatus); }
