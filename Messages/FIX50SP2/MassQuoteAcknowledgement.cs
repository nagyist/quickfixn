...
public class MassQuoteAcknowledgement : Message
{
    ...
    public NoTargetPartyIDs NoTargetPartyIDs
    {
        get
        {
            NoTargetPartyIDs val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(NoTargetPartyIDs val) { NoTargetPartyIDs = val; }
    public NoTargetPartyIDs Get(NoTargetPartyIDs val) { GetField(val); return val; }
    public bool IsSet(NoTargetPartyIDs val) { return IsSetNoTargetPartyIDs(); }
    ...
    public class NoQuoteSetsGroup : Group
    {
        ...
        public void Set(TotNoCxldQuotes val) { TotNoCxldQuotes = val; }
        public TotNoCxldQuotes Get(TotNoCxldQuotes val) { GetField(val); return val; }
        public bool IsSet(TotNoCxldQuotes val) { return IsSetTotNoCxldQuotes(); }
        ...
        public void Set(TotNoAccQuotes val) { TotNoAccQuotes = val; }
        public TotNoAccQuotes Get(TotNoAccQuotes val) { GetField(val); return val; }
        public bool IsSet(TotNoAccQuotes val) { return IsSetTotNoAccQuotes(); }
        ...
        public void Set(TotNoRejQuotes val) { TotNoRejQuotes = val; }
        public TotNoRejQuotes Get(TotNoRejQuotes val) { GetField(val); return val; }
        public bool IsSet(TotNoRejQuotes val) { return IsSetTotNoRejQuotes(); }
        ...
        public class NoQuoteEntriesGroup : Group
        {
            ...
            public void Set(QuoteEntryStatus val) { QuoteEntryStatus = val; }
            public QuoteEntryStatus Get(QuoteEntryStatus val) { GetField(val); return val; }
            public bool IsSet(QuoteEntryStatus val) { return IsSetQuoteEntryStatus(); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.TargetPartyID, Tags.TargetPartyIDSource, Tags.TargetPartyRole, 0];
        ...
        public NoTargetPartyIDsGroup()
          : base(Tags.NoTargetPartyIDs, Tags.TargetPartyID, DefaultFieldOrder)
        {
        }
        ...
        public void Set(TargetPartyID val) { TargetPartyID = val; }
        public TargetPartyID Get(TargetPartyID val) { GetField(val); return val; }
        public bool IsSet(TargetPartyID val) { return IsSetTargetPartyID(); }
        ...
        public void Set(TargetPartyIDSource val) { TargetPartyIDSource = val; }
        public TargetPartyIDSource Get(TargetPartyIDSource val) { GetField(val); return val; }
        public bool IsSet(TargetPartyIDSource val) { return IsSetTargetPartyIDSource(); }
        ...
        public void Set(TargetPartyRole val) { TargetPartyRole = val; }
        public TargetPartyRole Get(TargetPartyRole val) { GetField(val); return val; }
        public bool IsSet(TargetPartyRole val) { return IsSetTargetPartyRole(); }
