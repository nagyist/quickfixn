...
public class SecurityStatus : Message
{
    ...
    public Fields.SecurityStatus SecurityStatus_
    {
        get
        {
    ...
    public void Set(Fields.SecurityStatus val) { SecurityStatus_ = val; }
    ...
    public void Set(HaltReasonInt val) { HaltReasonInt = val; }
    public HaltReasonInt Get(HaltReasonInt val) { GetField(val); return val; }
    public bool IsSet(HaltReasonInt val) { return IsSetHaltReasonInt(); }
    public bool IsSetHaltReasonInt() { return IsSetField(Tags.HaltReasonInt); }
    ...
    public void Set(FirstPx val) { FirstPx = val; }
    public FirstPx Get(FirstPx val) { GetField(val); return val; }
    public bool IsSet(FirstPx val) { return IsSetFirstPx(); }
    public bool IsSetFirstPx() { return IsSetField(Tags.FirstPx); }

    public SecurityTradingEvent SecurityTradingEvent
    {
        get
        {
            SecurityTradingEvent val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(SecurityTradingEvent val) { SecurityTradingEvent = val; }
    public SecurityTradingEvent Get(SecurityTradingEvent val) { GetField(val); return val; }
    public bool IsSet(SecurityTradingEvent val) { return IsSetSecurityTradingEvent(); }
    public bool IsSetSecurityTradingEvent() { return IsSetField(Tags.SecurityTradingEvent); }
