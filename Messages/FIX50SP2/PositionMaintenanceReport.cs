...
public class PositionMaintenanceReport : Message
{
    ...
    {
        Header.SetField(new MsgType("AM"));
    }

    public PositionMaintenanceReport(
            PosMaintRptID aPosMaintRptID,
            PosTransType aPosTransType,
            PosMaintAction aPosMaintAction,
            PosMaintStatus aPosMaintStatus,
    ...
    public void Set(PosTransType val) { PosTransType = val; }
    public PosTransType Get(PosTransType val) { GetField(val); return val; }
    public bool IsSet(PosTransType val) { return IsSetPosTransType(); }
    public bool IsSetPosTransType() { return IsSetField(Tags.PosTransType); }
    ...
    public void Set(PosMaintAction val) { PosMaintAction = val; }
    public PosMaintAction Get(PosMaintAction val) { GetField(val); return val; }
    public bool IsSet(PosMaintAction val) { return IsSetPosMaintAction(); }
    public bool IsSetPosMaintAction() { return IsSetField(Tags.PosMaintAction); }

    public OrigPosReqRefID OrigPosReqRefID
    {
        get
        {
            OrigPosReqRefID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(OrigPosReqRefID val) { OrigPosReqRefID = val; }
    public OrigPosReqRefID Get(OrigPosReqRefID val) { GetField(val); return val; }
    public bool IsSet(OrigPosReqRefID val) { return IsSetOrigPosReqRefID(); }
    public bool IsSetOrigPosReqRefID() { return IsSetField(Tags.OrigPosReqRefID); }

    public PosMaintStatus PosMaintStatus
    {
        get
        {
            PosMaintStatus val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(PosMaintStatus val) { PosMaintStatus = val; }
    public PosMaintStatus Get(PosMaintStatus val) { GetField(val); return val; }
    public bool IsSet(PosMaintStatus val) { return IsSetPosMaintStatus(); }
    public bool IsSetPosMaintStatus() { return IsSetField(Tags.PosMaintStatus); }

    public PosMaintResult PosMaintResult
    {
        get
        {
            PosMaintResult val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(PosMaintResult val) { PosMaintResult = val; }
    public PosMaintResult Get(PosMaintResult val) { GetField(val); return val; }
    public bool IsSet(PosMaintResult val) { return IsSetPosMaintResult(); }
    public bool IsSetPosMaintResult() { return IsSetField(Tags.PosMaintResult); }
    ...
    public void Set(AdjustmentType val) { AdjustmentType = val; }
    public AdjustmentType Get(AdjustmentType val) { GetField(val); return val; }
    public bool IsSet(AdjustmentType val) { return IsSetAdjustmentType(); }
    public bool IsSetAdjustmentType() { return IsSetField(Tags.AdjustmentType); }
    ...
    public ContraryInstructionIndicator ContraryInstructionIndicator
    {
        get
        {
            ContraryInstructionIndicator val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(ContraryInstructionIndicator val) { ContraryInstructionIndicator = val; }
    public ContraryInstructionIndicator Get(ContraryInstructionIndicator val) { GetField(val); return val; }
    public bool IsSet(ContraryInstructionIndicator val) { return IsSetContraryInstructionIndicator(); }
    public bool IsSetContraryInstructionIndicator() { return IsSetField(Tags.ContraryInstructionIndicator); }

    public PriorSpreadIndicator PriorSpreadIndicator
    {
        get
        {
            PriorSpreadIndicator val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(PriorSpreadIndicator val) { PriorSpreadIndicator = val; }
    public PriorSpreadIndicator Get(PriorSpreadIndicator val) { GetField(val); return val; }
    public bool IsSet(PriorSpreadIndicator val) { return IsSetPriorSpreadIndicator(); }
    public bool IsSetPriorSpreadIndicator() { return IsSetField(Tags.PriorSpreadIndicator); }
