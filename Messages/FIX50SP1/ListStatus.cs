...
public class ListStatus : Message
{
    ...
    public void Set(ListRejectReason val) { ListRejectReason = val; }
    public ListRejectReason Get(ListRejectReason val) { GetField(val); return val; }
    public bool IsSet(ListRejectReason val) { return IsSetListRejectReason(); }
    public bool IsSetListRejectReason() { return IsSetField(Tags.ListRejectReason); }

    public class NoOrdersGroup : Group
    {
        public static int[] DefaultFieldOrder = [Tags.ClOrdID, Tags.SecondaryClOrdID, Tags.CumQty, Tags.OrdStatus, Tags.WorkingIndicator, Tags.LeavesQty, Tags.CxlQty, Tags.AvgPx, Tags.OrdRejReason, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, Tags.OrderID, 0];
