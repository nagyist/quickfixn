...
public class RegistrationInstructions : Message
{
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.RegistDetls, Tags.RegistEmail, Tags.MailingDtls, Tags.MailingInst, Tags.NoNestedPartyIDs, Tags.OwnerType, Tags.DateOfBirth, Tags.InvestorCountryOfResidence, 0];
        ...
        public NoRegistDtlsGroup()
          : base(Tags.NoRegistDtls, Tags.RegistDetls, DefaultFieldOrder)
        {
        }
        ...
        public RegistDetls RegistDetls
        {
            get
            {
                RegistDetls val = new();
        ...
        public void Set(RegistDetls val) { RegistDetls = val; }
        public RegistDetls Get(RegistDetls val) { GetField(val); return val; }
        public bool IsSet(RegistDetls val) { return IsSetRegistDetls(); }
        public bool IsSetRegistDetls() { return IsSetField(Tags.RegistDetls); }
