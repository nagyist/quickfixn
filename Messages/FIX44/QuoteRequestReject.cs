...
public class QuoteRequestReject : Message
{
    ...
    {
        Header.SetField(new MsgType("AG"));
    }

    public QuoteRequestReject(
            QuoteReqID aQuoteReqID,
            QuoteRequestRejectReason aQuoteRequestRejectReason
        ) : this()
    {
        QuoteReqID = aQuoteReqID;
        QuoteRequestRejectReason = aQuoteRequestRejectReason;
    ...
    public QuoteRequestRejectReason QuoteRequestRejectReason
    {
        get
        {
            QuoteRequestRejectReason val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(QuoteRequestRejectReason val) { QuoteRequestRejectReason = val; }
    public QuoteRequestRejectReason Get(QuoteRequestRejectReason val) { GetField(val); return val; }
    public bool IsSet(QuoteRequestRejectReason val) { return IsSetQuoteRequestRejectReason(); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.NoSecurityAltID, Tags.Product, Tags.CFICode, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.PutOrCall, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.OptAttribute, Tags.ContractMultiplier, Tags.CouponRate, Tags.SecurityExchange, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.AgreementDesc, Tags.AgreementID, Tags.AgreementDate, Tags.AgreementCurrency, Tags.TerminationType, Tags.StartDate, Tags.EndDate, Tags.DeliveryType, Tags.MarginRatio, Tags.NoUnderlyings, Tags.PrevClosePx, Tags.QuoteRequestType, Tags.QuoteType, Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.TradeOriginationDate, Tags.Side, Tags.QtyType, Tags.OrderQty, Tags.CashOrderQty, Tags.OrderPercent, Tags.RoundingDirection, Tags.RoundingModulus, Tags.SettlType, Tags.SettlDate, Tags.SettlDate2, Tags.OrderQty2, Tags.Currency, Tags.NoStipulations, Tags.Account, Tags.AcctIDSource, Tags.AccountType, Tags.NoLegs, 0];
