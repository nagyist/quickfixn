...
public class CollateralReport : Message
{
    ...
    {
        Header.SetField(new MsgType("BA"));
    }

    public CollateralReport(
            CollRptID aCollRptID,
            CollStatus aCollStatus
        ) : this()
    {
        CollRptID = aCollRptID;
        CollStatus = aCollStatus;
    ...
    public void Set(CollRptID val) { CollRptID = val; }
    public CollRptID Get(CollRptID val) { GetField(val); return val; }
    public bool IsSet(CollRptID val) { return IsSetCollRptID(); }
    public bool IsSetCollRptID() { return IsSetField(Tags.CollRptID); }
    ...
    public void Set(CollStatus val) { CollStatus = val; }
    public CollStatus Get(CollStatus val) { GetField(val); return val; }
    public bool IsSet(CollStatus val) { return IsSetCollStatus(); }
    public bool IsSetCollStatus() { return IsSetField(Tags.CollStatus); }
