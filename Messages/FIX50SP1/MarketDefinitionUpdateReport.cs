...
public class MarketDefinitionUpdateReport : Message
{
    ...
    {
        Header.SetField(new MsgType("BV"));
    }
    ...
    public void Set(MarketUpdateAction val) { MarketUpdateAction = val; }
    public MarketUpdateAction Get(MarketUpdateAction val) { GetField(val); return val; }
    public bool IsSet(MarketUpdateAction val) { return IsSetMarketUpdateAction(); }
    public bool IsSetMarketUpdateAction() { return IsSetField(Tags.MarketUpdateAction); }
