...
public class ContraryIntentionReport : Message
{
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.ExpirationQtyType, Tags.ExpQty, 0];

        [Obsolete("Use DefaultFieldOrder instead.  This will be removed in 1.16.")]
        public static int[] fieldOrder = {Tags.ExpirationQtyType, Tags.ExpQty, 0};

        public NoExpirationGroup()
          : base(Tags.NoExpiration, Tags.ExpirationQtyType, DefaultFieldOrder)
        {
        }
        ...
        public void Set(ExpirationQtyType val) { ExpirationQtyType = val; }
        public ExpirationQtyType Get(ExpirationQtyType val) { GetField(val); return val; }
        public bool IsSet(ExpirationQtyType val) { return IsSetExpirationQtyType(); }
        public bool IsSetExpirationQtyType() { return IsSetField(Tags.ExpirationQtyType); }
