...
public class QuoteRequestReject : Message
{
    ...
    public void Set(PrivateQuote val) { PrivateQuote = val; }
    public PrivateQuote Get(PrivateQuote val) { GetField(val); return val; }
    public bool IsSet(PrivateQuote val) { return IsSetPrivateQuote(); }
    public bool IsSetPrivateQuote() { return IsSetField(Tags.PrivateQuote); }

    public RespondentType RespondentType
    {
        get
        {
            RespondentType val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(RespondentType val) { RespondentType = val; }
    public RespondentType Get(RespondentType val) { GetField(val); return val; }
    public bool IsSet(RespondentType val) { return IsSetRespondentType(); }
    public bool IsSetRespondentType() { return IsSetField(Tags.RespondentType); }
