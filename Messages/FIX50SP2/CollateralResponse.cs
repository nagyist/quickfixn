...
public class CollateralResponse : Message
{
    ...
    {
        Header.SetField(new MsgType("AZ"));
    }

    public CollateralResponse(
            CollRespID aCollRespID,
            CollAsgnRespType aCollAsgnRespType,
    ...
    public void Set(CollRespID val) { CollRespID = val; }
    public CollRespID Get(CollRespID val) { GetField(val); return val; }
    public bool IsSet(CollRespID val) { return IsSetCollRespID(); }
    public bool IsSetCollRespID() { return IsSetField(Tags.CollRespID); }
    ...
    public void Set(CollAsgnRespType val) { CollAsgnRespType = val; }
    public CollAsgnRespType Get(CollAsgnRespType val) { GetField(val); return val; }
    public bool IsSet(CollAsgnRespType val) { return IsSetCollAsgnRespType(); }
    public bool IsSetCollAsgnRespType() { return IsSetField(Tags.CollAsgnRespType); }

    public CollAsgnRejectReason CollAsgnRejectReason
    {
        get
        {
            CollAsgnRejectReason val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(CollAsgnRejectReason val) { CollAsgnRejectReason = val; }
    public CollAsgnRejectReason Get(CollAsgnRejectReason val) { GetField(val); return val; }
    public bool IsSet(CollAsgnRejectReason val) { return IsSetCollAsgnRejectReason(); }
    public bool IsSetCollAsgnRejectReason() { return IsSetField(Tags.CollAsgnRejectReason); }
    ...
    public void Set(CollApplType val) { CollApplType = val; }
    public CollApplType Get(CollApplType val) { GetField(val); return val; }
    public bool IsSet(CollApplType val) { return IsSetCollApplType(); }
    public bool IsSetCollApplType() { return IsSetField(Tags.CollApplType); }
