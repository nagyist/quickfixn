...
public class SecurityListUpdateReport : Message
{
    ...
    {
        Header.SetField(new MsgType("BK"));
    }
    ...
    public void Set(SecurityListID val) { SecurityListID = val; }
    public SecurityListID Get(SecurityListID val) { GetField(val); return val; }
    public bool IsSet(SecurityListID val) { return IsSetSecurityListID(); }
    public bool IsSetSecurityListID() { return IsSetField(Tags.SecurityListID); }

    public SecurityListRefID SecurityListRefID
    {
        get
        {
            SecurityListRefID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(SecurityListRefID val) { SecurityListRefID = val; }
    public SecurityListRefID Get(SecurityListRefID val) { GetField(val); return val; }
    public bool IsSet(SecurityListRefID val) { return IsSetSecurityListRefID(); }
    public bool IsSetSecurityListRefID() { return IsSetField(Tags.SecurityListRefID); }

    public SecurityListDesc SecurityListDesc
    {
        get
        {
            SecurityListDesc val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(SecurityListDesc val) { SecurityListDesc = val; }
    public SecurityListDesc Get(SecurityListDesc val) { GetField(val); return val; }
    public bool IsSet(SecurityListDesc val) { return IsSetSecurityListDesc(); }
    public bool IsSetSecurityListDesc() { return IsSetField(Tags.SecurityListDesc); }

    public EncodedSecurityListDescLen EncodedSecurityListDescLen
    {
        get
        {
            EncodedSecurityListDescLen val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(EncodedSecurityListDescLen val) { EncodedSecurityListDescLen = val; }
    public EncodedSecurityListDescLen Get(EncodedSecurityListDescLen val) { GetField(val); return val; }
    public bool IsSet(EncodedSecurityListDescLen val) { return IsSetEncodedSecurityListDescLen(); }
    public bool IsSetEncodedSecurityListDescLen() { return IsSetField(Tags.EncodedSecurityListDescLen); }

    public EncodedSecurityListDesc EncodedSecurityListDesc
    {
        get
        {
            EncodedSecurityListDesc val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(EncodedSecurityListDesc val) { EncodedSecurityListDesc = val; }
    public EncodedSecurityListDesc Get(EncodedSecurityListDesc val) { GetField(val); return val; }
    public bool IsSet(EncodedSecurityListDesc val) { return IsSetEncodedSecurityListDesc(); }
    public bool IsSetEncodedSecurityListDesc() { return IsSetField(Tags.EncodedSecurityListDesc); }

    public SecurityListType SecurityListType
    {
        get
        {
            SecurityListType val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(SecurityListType val) { SecurityListType = val; }
    public SecurityListType Get(SecurityListType val) { GetField(val); return val; }
    public bool IsSet(SecurityListType val) { return IsSetSecurityListType(); }
    public bool IsSetSecurityListType() { return IsSetField(Tags.SecurityListType); }

    public SecurityListTypeSource SecurityListTypeSource
    {
        get
        {
            SecurityListTypeSource val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(SecurityListTypeSource val) { SecurityListTypeSource = val; }
    public SecurityListTypeSource Get(SecurityListTypeSource val) { GetField(val); return val; }
    public bool IsSet(SecurityListTypeSource val) { return IsSetSecurityListTypeSource(); }
    public bool IsSetSecurityListTypeSource() { return IsSetField(Tags.SecurityListTypeSource); }
    ...
    public class NoRelatedSymGroup : Group
    {
        ...
        public void Set(ListUpdateAction val) { ListUpdateAction = val; }
        public ListUpdateAction Get(ListUpdateAction val) { GetField(val); return val; }
        public bool IsSet(ListUpdateAction val) { return IsSetListUpdateAction(); }
        public bool IsSetListUpdateAction() { return IsSetField(Tags.ListUpdateAction); }
        ...
        public void Set(RelSymTransactTime val) { RelSymTransactTime = val; }
        public RelSymTransactTime Get(RelSymTransactTime val) { GetField(val); return val; }
        public bool IsSet(RelSymTransactTime val) { return IsSetRelSymTransactTime(); }
        public bool IsSetRelSymTransactTime() { return IsSetField(Tags.RelSymTransactTime); }
