...
public class StreamAssignmentReport : Message
{
    ...
    {
        Header.SetField(new MsgType("CD"));
    }
    ...
    public void Set(StreamAsgnReqType val) { StreamAsgnReqType = val; }
    public StreamAsgnReqType Get(StreamAsgnReqType val) { GetField(val); return val; }
    public bool IsSet(StreamAsgnReqType val) { return IsSetStreamAsgnReqType(); }
    public bool IsSetStreamAsgnReqType() { return IsSetField(Tags.StreamAsgnReqType); }

    public StreamAsgnReqID StreamAsgnReqID
    {
        get
        {
            StreamAsgnReqID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(StreamAsgnReqID val) { StreamAsgnReqID = val; }
    public StreamAsgnReqID Get(StreamAsgnReqID val) { GetField(val); return val; }
    public bool IsSet(StreamAsgnReqID val) { return IsSetStreamAsgnReqID(); }
    public bool IsSetStreamAsgnReqID() { return IsSetField(Tags.StreamAsgnReqID); }

    public NoAsgnReqs NoAsgnReqs
    {
        get
        {
            NoAsgnReqs val = new();
    ...
    public void Set(NoAsgnReqs val) { NoAsgnReqs = val; }
    public NoAsgnReqs Get(NoAsgnReqs val) { GetField(val); return val; }
    public bool IsSet(NoAsgnReqs val) { return IsSetNoAsgnReqs(); }
    public bool IsSetNoAsgnReqs() { return IsSetField(Tags.NoAsgnReqs); }

    public class NoAsgnReqsGroup : Group
    {
        public static int[] DefaultFieldOrder = [Tags.NoPartyIDs, Tags.NoRelatedSym, 0];
        ...
        public NoAsgnReqsGroup()
          : base(Tags.NoAsgnReqs, Tags.NoPartyIDs, DefaultFieldOrder)
        {
        }
        ...
        public class NoRelatedSymGroup : Group
        {
            ...
            public void Set(StreamAsgnType val) { StreamAsgnType = val; }
            public StreamAsgnType Get(StreamAsgnType val) { GetField(val); return val; }
            public bool IsSet(StreamAsgnType val) { return IsSetStreamAsgnType(); }
            public bool IsSetStreamAsgnType() { return IsSetField(Tags.StreamAsgnType); }
            ...
            public void Set(MDStreamID val) { MDStreamID = val; }
            public MDStreamID Get(MDStreamID val) { GetField(val); return val; }
            public bool IsSet(MDStreamID val) { return IsSetMDStreamID(); }
            public bool IsSetMDStreamID() { return IsSetField(Tags.MDStreamID); }
